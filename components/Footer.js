    ...
    <footer className="bg-wa-dark-gray text-white mt-12">
      <div className="container-wrapper py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm">
              Providing guidance and recommendations on the administration of permanent supportive housing programs managed by the Department of Commerce.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="text-sm text-gray-300 space-y-2">
              ...
              <p className="mt-2">
                <a href="tel:360-725-4000" className="hover:text-white transition-colors">
                  360-725-4000
                </a>
              </p>
            </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-600 text-center text-sm text-gray-400">
          <p>&copy; {currentYear} Washington State Department of Commerce. All rights reserved.</p>
          <p className="mt-2">
