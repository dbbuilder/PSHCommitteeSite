...
// In production, use a proper database like PostgreSQL, MongoDB, or Vercel KV
...
function initializeStore() {
  if (!documentsStore) {
    documentsStore = [...defaultDocuments];
  }
...
export function getDocumentById(id) {
  const documents = initializeStore();
...
// Note: This is an in-memory store that will reset on each deployment
// In production, use a proper database solution
